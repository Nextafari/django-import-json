...
def export_csv(aircraft_queryset, flight_queryset, *args, **kwargs):
    ...
    with file_path.open("w", newline="") as csvfile:
        ...
        for data in aircraft_data:
            writer.writerow([data["meta"].get(col) for col in aircraft_headers])
